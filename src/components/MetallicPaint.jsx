...
export default function MetallicPaint({ imageSrc, scale, params = defaultParams }) {
    ...
    useEffect(() => {
        ...
        fetch(imageSrc)
            ...
            .catch(err => console.error('Error loading image for MetallicPaint:', err));
    }, [imageSrc]);
    ...
    useEffect(() => {
        ...
        function resizeCanvas() {
            ...
            const side = 1000;
            canvasEl.width = side * window.devicePixelRatio;
            canvasEl.height = side * window.devicePixelRatio;
    ...
    if (webglFailed) {
        return <img src={imageSrc} alt="logo" className="block w-full h-full object-contain" style={{ filter: 'brightness(1.2) contrast(1.1)' }} />;
    }
